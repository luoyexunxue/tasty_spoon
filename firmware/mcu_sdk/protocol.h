...
******************************************************************************/
#define PRODUCT_KEY "lub2dli4"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define BT_UART_SEND_BUF_LMT         128              //According to the size of the user's DP data, it must be greater than 32
/******************************************************************************
...
//味道(可下发可上报)
//备注:
#define DPID_TASTE 102
//电池电压(只上报)
//备注:
#define DPID_VOLTAGE 103
